...
function addItemToCart(title, price, imageSrc) {
    ...
    <td>
      <div class="Counter">
        <span class="down" onclick="decreaseCount(event,this)"><button> - </button></span>
        <input type="text" class="cart-quantity-input" value="1"/>
        <span class="up" onclick="increaseCount(event,this)"><button> + </button></span>
      </div>
    </td>
    <td>₹ ${price}</td>       
  </tr>
